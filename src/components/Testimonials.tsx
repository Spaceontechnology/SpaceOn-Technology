...
export default function Testimonials() {
  ...
  return (
    <section className="relative w-full py-28 bg-[#f9fafd] dark:bg-[#080808]/90 overflow-hidden border-y border-neutral-200/50 dark:border-white/5 px-5 md:px-[60px] lg:px-[120px]" id="testimonials">
      {/* Absolute ambient backgrounds */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[300px] bg-neutral-200/20 dark:bg-neutral-800/10 blur-[150px] rounded-full pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto z-10 relative">
        ...
        <div className="text-center mb-16 max-w-2xl mx-auto">
          ...
          <p className="text-[15px] text-neutral-700 dark:text-neutral-300 leading-relaxed font-medium">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="relative bg-white dark:bg-neutral-900/80 rounded-[32px] p-8 md:p-14 overflow-hidden shadow-[0_30px_70px_rgba(0,0,0,0.035),0_1px_3px_rgba(0,0,0,0.015)] dark:shadow-[0_30px_70px_rgba(0,0,0,0.4)] border border-transparent dark:border-white/[0.04] min-h-[340px] flex flex-col justify-between">
            ...
            <div className="absolute inset-0 opacity-[0.02] pointer-events-none bg-[radial-gradient(#000_1px,transparent_1px)] dark:bg-[radial-gradient(#fff_1px,transparent_1px)] [background-size:24px_24px]" />
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="flex justify-between items-center">
                  <Quote className="w-10 h-10 text-neutral-200/80 dark:text-neutral-800" />
                ...
                {/* Testimonial message */}
                <p className="text-lg sm:text-xl md:text-2xl font-medium text-neutral-800 dark:text-neutral-200 tracking-tight leading-relaxed italic">
                ...
                <div className="flex items-center justify-between pt-6 border-t border-neutral-100 dark:border-neutral-800">
                  <div className="flex items-center gap-4">
                    ...
                    />
                    <div>
                      <h4 className="text-[15px] font-bold text-neutral-900 dark:text-white tracking-tight flex items-center gap-1.5 font-sans">
                        {testimonials[activeIndex].name}
                        <span className="w-1.5 h-1.5 rounded-full bg-emerald-600 dark:bg-emerald-450" title="Verifiably Authenticated Client Profile" />
                      </h4>
                      <p className="text-[12px] text-neutral-600 dark:text-neutral-400 font-medium">
                        {testimonials[activeIndex].role} &middot; <span className="text-neutral-950 dark:text-neutral-200 font-bold">{testimonials[activeIndex].company}</span>
                      </p>
                    </div>
                  </div>

                  <span className="hidden sm:inline-block text-[10px] font-mono tracking-widest text-neutral-600 dark:text-neutral-500 uppercase font-bold">
            ...
            <div className="flex items-center justify-between mt-10 relative z-10 pt-4 border-t border-neutral-100 dark:border-neutral-800">
                ...
                {testimonials.map((_, idx) => (
                  <button
                    ...
                    className={`h-1.5 rounded-full transition-all duration-300 ${
                      activeIndex === idx ? 'w-6 bg-neutral-900 dark:bg-white' : 'w-2 bg-neutral-200 dark:bg-neutral-800 hover:bg-neutral-300 dark:hover:bg-neutral-700'
                    }`}
