...
export default function FeaturedProjects({ onOpenCaseStudy }: FeaturedProjectsProps) {
  ...
  const projects = [
    {
      id: 'luminary-ai',
      title: 'Luminary AI Analytical Graph Node',
      category: 'COGNITIVE COMPUTING / AI',
      ...
      badge: '99.4% Reasoning Accuracy',
      stack: ['PyTorch', 'Rust', 'Neo4j', 'FastAPI'],
      icon: Sparkles,
    ...
    },
    {
      ...
      category: 'CRYPTOGRAPHIC / FINTECH CAPABILITY',
      description: 'High-throughput sovereign consensus framework scaling settlement layers for multi-billion dollar decentralized financial applications.',
      metrics: '140,000+ Trans / Sec Settle SLA',
      image: 'https://images.unsplash.com/photo-1639762681485-074b7f938ba0?q=80&w=2832&auto=format&fit=crop',
      badge: 'Sub-second Finality',
      stack: ['Rust', 'WebAssembly', 'gRPC', 'RocksDB'],
      icon: Shield,
      accent: 'rgba(255,255,255,0.08)'
    },
    {
      id: 'vortex-mid',
      title: 'Vortex Cloud Core Engine Optimizer',
      category: 'DISTRIBUTED ARCHITECTURE / SAAS',
      description: 'High-density container scheduler allocating CPU and operational database resources globally with microsecond latency profiles.',
      ...
      badge: 'Zero Caching Overheads',
      stack: ['Go', 'eBPF', 'Kubernetes', 'Prometheus'],
      icon: Database,
